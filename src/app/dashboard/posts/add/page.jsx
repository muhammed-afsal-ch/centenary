...
export default function PostForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-green-400 to-green-100 flex items-center justify-center py-10">
      <form onSubmit={handleSubmit} className="max-w-xl w-full mx-auto bg-white p-6 rounded-xl shadow-xl space-y-6">
        ...
        {message && (
          <div className="mt-4 text-center font-medium text-green-600">{message}</div>
        )}
        {error && <div className="mt-4 text-center font-medium text-red-600">{error}</div>}
      </form>
